...
This module provides envoy_ awesomeness.
"""
import os
import shlex
import signal
...
class ConnectedCommand(object):
    def __init__(self, process=None, std_in=None, std_out=None, std_error=None):
...
def expand_args(command):
    """Parses command strings and return s a Popen-ready list."""
